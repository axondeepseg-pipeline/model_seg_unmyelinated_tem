...
Originally used in https://github.com/axondeepseg/model_seg_generalist
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--name",
        default="Dataset043_TEM_UNMYELINATED_AGG",
        help="Name of the aggregated dataset. Default: 'Dataset043_TEM_UNMYELINATED_AGG'",
    )
    parser.add_argument(
        "--description",
        default="Combined datasets for myelinated and unmyelinated axon segmentation",
        help="Description of the aggregated dataset. Default: 'Combined datasets for myelinated and unmyelinated axon segmentation'",
    )
    parser.add_argument(
        "--k",
        type=int,
